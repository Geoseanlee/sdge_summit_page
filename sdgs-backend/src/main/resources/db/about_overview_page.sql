...
VALUES
    ('zh-CN',
     ...
     '更多', '#', 'https://static.example.com/hero.jpg',
     '<p>世博全球青年联盟（World Expo Global Young Alliance）在迪拜世博会期间，由世博全球青年SDGs峰会组委会与SDGsVision 2050发起，在迪拜世博会中华文化馆与中华文化促进会支持下成立，为激发全球青年为实现可持续发展目标SDGs（也称为全球目标和2030年议程）作出贡献的行动。/n世博全球青年联盟将连接全球的创意机构和人才，汇聚全球产业界、政界、学界、商界力量着力落实《联合国2030年可持续发展议程》，促进社会进步、环境保护、经济建设可持续发展。</p>',
     JSON_ARRAY(
             JSON_OBJECT('image','https://static.example.com/adv1.jpg','title','2025年世博全球青年团队携手联合国教科文组织参与日本大阪世博会','desc','依托世博会和联合国科教文组织的世界影响力，我们为品牌提供权威认可，助力全球传播，提升品牌公信力与国际竞争力。'),
             JSON_OBJECT('image','https://static.example.com/adv2.jpg','title','广泛的海内外青年与高校社群','desc','社群成员覆盖全球192个国家、7000万人次，直接链接1000+高校及130+知名媒体资源，助力品牌传播。'),
             JSON_OBJECT('image','https://static.example.com/adv3.jpg','title','跨界联动，融合艺术与科技','desc','打破行业边界，将艺术与科技深度融入品牌建设中，跨界联动，构建多元传播生态，拓展全球影响力。')
     ),
     JSON_ARRAY(
     ...
     JSON_ARRAY('unops.png','italy.png','cnn.png'),
     JSON_ARRAY('cssa.png','model_apec.png'),
     JSON_ARRAY('ucl_cssa.png','kcl_cssa.png'),
     1  -- 草稿
    );
